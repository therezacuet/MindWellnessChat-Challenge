...
mixin _$NetworkExceptions {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(String error, int errorCode) defaultError,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(String error, int errorCode)? defaultError,
...
class _$DefaultErrorImpl implements DefaultError {
  const _$DefaultErrorImpl(this.error, this.errorCode);
  ...
  @override
  String toString() {
    return 'NetworkExceptions.defaultError(error: $error, errorCode: $errorCode)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return defaultError(error, errorCode);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return defaultError?.call(error, errorCode);
  }
...
abstract class DefaultError implements NetworkExceptions {
  const factory DefaultError(final String error, final int errorCode) =
      _$DefaultErrorImpl;
